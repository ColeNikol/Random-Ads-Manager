document.addEventListener("DOMContentLoaded", function () {
    ...
    const adsContainerId = "two-responsive-ads";
    ...
    style.textContent = `
        ...
        .responsive-ad {
            flex: 1 1 calc(50% - 10px); /* Two ads in a row */
    ...
    function displayAds(ads) {
        ...
        // Shuffle ads and pick 2 unique ones
        const shuffledAds = ads.sort(() => 0.5 - Math.random()).slice(0, 2);
